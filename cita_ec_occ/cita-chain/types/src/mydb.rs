...
// database columns
/// Column for State
pub const MYCOL_STATE: Option<u32> = Some(0);
/// Column for DataBlock
pub const MYCOL_DATABLOCKS: Option<u32> = Some(1);
/// Column for DataBlockSize
pub const MYCOL_SIZE: Option<u32> = Some(2);
/// Column for MaxDataBlockSize
pub const MYCOL_MAXSIZE: Option<u32> = Some(3);
/// Column for ConsensusNodes
pub const MYCOL_CONSENSUS_NODES: Option<u32> = Some(4);
/// Column for k
pub const MYCOL_K: Option<u32> = Some(5);
/// Column for m
pub const MYCOL_M: Option<u32> = Some(6);
/// Column for Extras
pub const MYCOL_EXTRA: Option<u32> = Some(7);

pub const MYCOL_ALLNODES: Option<u32> = Some(8);
// /// Column for Traces
...
pub const MYNUM_COLUMNS: Option<u32> = Some(9);
